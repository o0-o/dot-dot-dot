# Generated by Powerlevel10k configuration wizard on 2020-12-24 at 15:14 EST.
...
() {
  ...
  #  '*'               DEFAULT  ''
  #)
  #typeset -g POWERLEVEL9K_DIR_DIRENV_BACKGROUND=6
  ...
  typeset -g POWERLEVEL9K_DIRENV_VISUAL_IDENTIFIER_EXPANSION=' ${PWD/#$DIRENV_DIR\//} '
  typeset -g POWERLEVEL9K_DIRENV_SHOW_NONE=false
  typeset -g POWERLEVEL9K_DIRENV_SHOW_FAILS=true
  # Custom icon.
